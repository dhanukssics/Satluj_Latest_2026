...
namespace Satluj_Latest.Data
{
    public class DeclaredExams : BaseReference
    {
        ...
        public DeclaredExams(TbDeclaredExam obj)
        {
            exams = obj;
        }

        public DeclaredExams(long Id)
        {
            exams = _Entities.TbDeclaredExams.FirstOrDefault(z => z.Id == Id);
        }
        ...
        {
            get { return exams.TbExamTerm != null ? exams.TbExamTerm.DefaultExam : ""; }
        }

        public string ExamName
        {
            get { return exams.Exam != null ? exams.Exam.ExamName : ""; }
        }

        public string ClassName
        {
            get { return exams.Class != null ? exams.Class.Class : ""; }
        }
    }
}