...
public partial class ParentXi
{
    ...
    public double? MotherPincode { get; set; }
    ...
    public string? Kid1ClassDivision { get; set; }

    public string? Kid2 { get; set; }

    public string? Kid2ClassDivision { get; set; }

    public string? Kid3 { get; set; }

    public string? Kid3ClassDivision { get; set; }
