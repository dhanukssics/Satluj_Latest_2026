...
public partial class TbAspectsRelativeAreaSkill
{
    ...
    public string ComputerScience { get; set; } = null!;

    public string GeneralStudies { get; set; } = null!;

    public string ValueEducation { get; set; } = null!;

    public string French { get; set; } = null!;

    public string SmartClass { get; set; } = null!;
